            ...
            <div className="container login1:grid-cols-Customcol3 login3:gap-20 w-screen h-screen grid grid-cols-Customcol1 gap-28 py-0 px-8">
                ...
                <div className="login-content login1:justify-center login1:-mt-52 flex justify-center items-center text-center">
                    ...
                    <div className='login2:w-72.5 w-90'>
                        ...
                        <Link to="/login"><a href="#" className='block text-right no-underline text-links text-base transition-all duration-.3 hover:text-primary'>Already have an account? </a></Link>

                        <input type="submit" className="block w-full h-12 rounded-3xl outline-none border-none bg-grad1 bg-200% text-white text-xl uppercase my-4 mx-0 cursor-pointer transition-all duration-.5 hover:bg-right" value="Login" onClick={handleRegister} />
                    </div>
                </div>
            </div>
        </div>
